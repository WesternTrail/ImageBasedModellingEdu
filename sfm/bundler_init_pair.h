...
public:
    struct Options
    {
         ...
         */
        RansacHomography::Options homography_opts; // 是否使用单应矩阵？

        /**
         * The maximum percentage of homography inliers.
         */
        float max_homography_inliers;  // 单应矩阵的最大内点个数

        /**
         * Minimum number of pair matches. Minimum is 8.
         */
        int min_num_matches; // 最小数量的匹配

        /**
         * Minimum triangulation angle of tracks (in radians).
         */
        double min_triangulation_angle; // 最小的三角跟踪
